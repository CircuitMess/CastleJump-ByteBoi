#ifndef CASTLEJUMP_HIGHSCORE_H
#define CASTLEJUMP_HIGHSCORE_H

#include <Arduino.h>

#define HS_NAME_LIMIT 3 // player name character limit
#define HS_MAX_SCORES 5 // # of players in HS
#define HS_FILENAME "/NoviPrNibble" // SPIFFS filename for the HS, max 31 char
